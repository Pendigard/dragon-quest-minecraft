...
public class KingSlimeEntity extends Monster {
    ...
    public KingSlimeEntity(EntityType<? extends Monster> p_33002_, Level p_33003_) {
    ...
    public static boolean canSpawn(EntityType<KingSlimeEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
