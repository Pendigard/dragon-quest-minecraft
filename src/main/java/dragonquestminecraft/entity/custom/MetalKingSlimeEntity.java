...
public class MetalKingSlimeEntity extends KingSlimeEntity {
    public MetalKingSlimeEntity(EntityType<? extends Monster> p_33002_, Level p_33003_) {
    ...
    public static boolean canMetalSpawn(EntityType<MetalKingSlimeEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
