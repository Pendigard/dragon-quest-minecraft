...
public class GiganteEntity extends Monster {

    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(GiganteEntity.class, EntityDataSerializers.BOOLEAN);
    public GiganteEntity(EntityType<? extends Monster> p_33002_, Level p_33003_) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(0, new GiganteAttackGoal(this, 1.0D, true));
    ...
    public static boolean canSpawn(EntityType<GiganteEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
