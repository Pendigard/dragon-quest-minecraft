...
public class BubbleSlimeEntity extends Monster {
    public BubbleSlimeEntity(EntityType<? extends Monster> p_33002_, Level p_33003_) {
    ...
    public static boolean canSpawn(EntityType<BubbleSlimeEntity> entityType, ServerLevelAccessor level, MobSpawnType spawnType, BlockPos pos, RandomSource random) {
