            ...
            CREATIVE_MODE_TABS.register("dragon_quest_tab",
                    () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.SLIME_DROP.get()))
                            ...
                            .displayItems((p_270258_, p_259752_) ->  {
                                ...
                                p_259752_.accept(ModItems.MISCHIEVOUS_MOLE_SPAWN_EGG.get());
                                p_259752_.accept(ModItems.KING_SLIME_SPAWN_EGG.get());
                                p_259752_.accept(ModItems.METAL_KING_SLIME_SPAWN_EGG.get());
                                ...
                                p_259752_.accept(ModItems.GIGANTE_SPAWN_EGG.get());
                                p_259752_.accept(ModItems.ATLAS_SPAWN_EGG.get());
                            })
                            .build());
